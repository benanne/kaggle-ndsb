...
if save_every > num_chunks_train: print "WARNING: NOT SAVING METADATA!!!"

sdir = "/mnt/storage/users/sedielem/git/kaggle-plankton/predictions/"
train_pred_file = sdir+"train--convroll4_big_wd_maxout512--convroll4_big_wd_maxout512-paard-20150224-152051--avg-probs.npy"
valid_pred_file = sdir+"valid--convroll4_big_wd_maxout512--convroll4_big_wd_maxout512-paard-20150224-152051--avg-probs.npy"
test_pred_file =  sdir+"test--convroll4_big_wd_maxout512--convroll4_big_wd_maxout512-paard-20150224-152051--avg-probs.npy"
